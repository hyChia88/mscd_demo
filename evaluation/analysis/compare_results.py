...
Reads eval JSON files from logs/evaluation_output/ and prints a side-by-side
...
Usage:
  # Auto-discover mode (scan logs/evaluation_output/)
  ...
  python script/compare_results.py \\
    --traces logs/evaluation_output/traces_A_v2_prompt.jsonl --label "V2 Prompt" \\
    --traces logs/evaluation_output/traces_B_v2_lora.jsonl  --label "V2 LoRA" \\
...
def generate_comparison_charts(
    ...
    Reuses chart functions from src/evaluation_infra/visualizations.py where possible,
    ...
    from src.evaluation_infra.visualizations import (
...
def main():
    ...
    parser.add_argument(
        "--dir", default="logs/evaluation_output",
        help="Directory containing eval results (default: logs/evaluation_output)",
    )
    parser.add_argument(
