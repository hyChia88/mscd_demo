...
![Fig 1. Search Space Reduction — Initial pool (1,666) narrowed to 83 final candidates (95% reduction)](../plots/comparisons/v1_vs_v2/2_search_space_reduction.png)
...
![Fig 3. Performance across all conditions (A1–C3), grouped by modality](../plots/comparisons/v1_vs_v2/7_condition_comparison.png)

![Fig 4. VLM integration impact — B/C conditions improve from 0% to 41.3% Top-1 after adding Gemini VLM image parsing](../plots/comparisons/v1_vs_v2/5_vision_impact.png)

![Fig 5. Per-case retrieval success heatmap — GUID, Name, and Storey match across all 43 cases](../plots/comparisons/v1_vs_v2/6_per_case_heatmap.png)
...
![Fig 5. Per-case retrieval success heatmap — GUID, Name, and Storey match across all 43 cases](../plots/comparisons/v1_vs_v2/8_efficiency_comparison.png)
